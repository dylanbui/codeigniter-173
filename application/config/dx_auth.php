...
$config['DX_users_table'] = 'core_users';
$config['DX_user_profile_table'] = 'core_user_profile';
$config['DX_user_temp_table'] = 'core_user_temp';
$config['DX_user_autologin'] = 'core_user_autologin';
$config['DX_roles_table'] = 'core_roles';
$config['DX_permissions_table'] = 'core_permissions';
$config['DX_login_attempts_table'] = 'core_login_attempts';
...
$config['DX_captcha_width'] = 220;
$config['DX_captcha_height'] = 45;
$config['DX_captcha_font_size'] = '12'; 
...
$config['DX_deny_uri'] = '/user/auth/deny/';
$config['DX_login_uri'] = '/user/auth/login/';
$config['DX_banned_uri'] = '/user/auth/banned/';
$config['DX_activate_uri'] = '/user/auth/activate/';
$config['DX_reset_password_uri'] = '/user/auth/reset_password/';
...
// URI Locations
$config['DX_logout_uri'] = '/user/auth/logout/';
$config['DX_register_uri'] = '/user/auth/register/';
$config['DX_forgot_password_uri'] = '/user/auth/forgot_password/';
$config['DX_change_password_uri'] = '/user/auth/change_password/';
$config['DX_cancel_account_uri'] = '/user/auth/cancel_account/';

// Forms view
$config['DX_login_view'] = 'user/auth/login_form';
$config['DX_register_view'] = 'user/auth/register_form';
$config['DX_forgot_password_view'] = 'user/auth/forgot_password_form';
$config['DX_change_password_view'] = 'user/auth/change_password_form';
$config['DX_cancel_account_view'] = 'user/auth/cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'user/auth/general_message';
$config['DX_banned_view'] = 'user/auth/general_message';
$config['DX_logged_in_view'] = 'user/auth/general_message';
$config['DX_logout_view'] = 'user/auth/general_message';

$config['DX_register_success_view'] = 'user/auth/general_message';
$config['DX_activate_success_view'] = 'user/auth/general_message';
$config['DX_forgot_password_success_view'] = 'user/auth/general_message';
$config['DX_reset_password_success_view'] = 'user/auth/general_message';
$config['DX_change_password_success_view'] = 'user/auth/general_message';

$config['DX_register_disabled_view'] = 'user/auth/general_message';
$config['DX_activate_failed_view'] = 'user/auth/general_message';
$config['DX_reset_password_failed_view'] = 'user/auth/general_message';
