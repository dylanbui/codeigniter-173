...
CREATE TABLE IF NOT EXISTS `core_ci_sessions` (
...
INSERT INTO `core_roles` (`id`, `parent_id`, `name`) VALUES
(1, 0, 'User'),
(2, 0, 'Admin');
...
INSERT INTO `core_users` (`id`, `role_id`, `username`, `password`, `email`, `banned`, `ban_reason`, `newpass`, `newpass_key`, `newpass_time`, `last_ip`, `last_login`, `created`, `modified`) VALUES
...
INSERT INTO `core_user_profile` (`id`, `user_id`, `country`, `website`) VALUES
(1, 1, NULL, NULL);
